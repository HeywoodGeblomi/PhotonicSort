#pragma once
/*
 * residual_push_middle_i32 — 3-run merge residual for sorted-prefix + island + sorted-suffix
...
namespace residual_push_middle_i32 {

inline bool try_push_middle(int32_t *a, size_t n) {
