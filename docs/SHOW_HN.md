...
Type: **Show HN** (you built it; include a working repo people can clone)
...
Prefer the technical page once Pages is live:
...
- Respond to technical comments; ignore username digs or correct once and move on.
